      ...
      <div className="modal__mask">
        <div className="modal__window">
          ...
          <div className="modal__body">
            <label htmlFor="groupName" className={styles.modal__label}>Введите название группы:</label>
            <input type="text" className={styles.modal__input} placeholder="21ИС3-4Д" id="groupName"/>
            
            <button className={styles.modal__button} onClick={addGroup} id="studentAddBtn">Добавить</button>
          </div>
