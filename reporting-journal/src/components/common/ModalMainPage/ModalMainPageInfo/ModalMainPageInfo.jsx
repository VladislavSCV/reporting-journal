...
import styles from './ModalMainPageInfo.module.scss'
      ...
      <div className="modal__mask">
        ...
        <header className="modal__header">
          ...
          <div className="modal__body">
            <p className={styles.modal__text}>Для получения доступа обратитесь к администратору сайта, он выдаст вам логин и пароль для входа в аккаунт</p>
