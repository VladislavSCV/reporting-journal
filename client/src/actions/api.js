...
//
//   try {
//     const response = await fetch('https://reporting-journal-2.onrender.com/api/auth/verify', {
//       method: 'POST',
//       headers: {
...
export async function loginUser(login, password) {
  ...
  try {
    const response = await fetch('https://reporting-journal-2.onrender.com/api/auth/login', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ login, password })
    });
...
async function getCurrentUser() {
  const token = localStorage.getItem('token');
  const response = await fetch('https://reporting-journal-2.onrender.com/api/auth', {
    method: 'GET',
...
async function getUserById(userId) {
  const response = await fetch(`https://reporting-journal-2.onrender.com/api/user/${userId}`, {
    method: 'GET',
    headers: { 'Authorization': `Bearer ${localStorage.getItem('token')}` }
  });
  return response.json();
...
async function deleteRole(roleId) {
  const response = await fetch(`https://reporting-journal-2.onrender.com/api/role/${roleId}`, {
    method: 'DELETE',
    headers: { 'Authorization': `Bearer ${localStorage.getItem('token')}` }
  });
  return response.ok;
...
async function addGroup(name, body) {
  const response = await fetch('https://reporting-journal-2.onrender.com/api/groups', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
      'Authorization': `Bearer ${localStorage.getItem('token')}`
...
async function deleteGroup(groupId) {
  const response = await fetch(`https://reporting-journal-2.onrender.com/api/groups/${groupId}`, {
    method: 'DELETE',
    headers: { 'Authorization': `Bearer ${localStorage.getItem('token')}` }
  });
  return response.ok;
...
async function addNote(title, body, groupId) {
  const response = await fetch('https://reporting-journal-2.onrender.com/api/notes', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
      'Authorization': `Bearer ${localStorage.getItem('token')}`
...
async function deleteNote(noteId) {
  const response = await fetch(`https://reporting-journal-2.onrender.com/api/notes/${noteId}`, {
    method: 'DELETE',
    headers: { 'Authorization': `Bearer ${localStorage.getItem('token')}` }
  });
  return response.ok;
...
async function addSchedule(groupId, dayOfWeek, subject, teacher) {
  const response = await fetch('https://reporting-journal-2.onrender.com/api/schedule', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
      'Authorization': `Bearer ${localStorage.getItem('token')}`
...
async function deleteSchedule(scheduleId) {
  const response = await fetch(`https://reporting-journal-2.onrender.com/api/schedule/${scheduleId}`, {
    method: 'DELETE',
    headers: { 'Authorization': `Bearer ${localStorage.getItem('token')}` }
  });
  return response.ok;
...
async function addStudent(name, groupId, role) {
  const response = await fetch('https://reporting-journal-2.onrender.com/api/students', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
      'Authorization': `Bearer ${localStorage.getItem('token')}`
...
async function deleteStudent(studentId) {
  const response = await fetch(`https://reporting-journal-2.onrender.com/api/students/${studentId}`, {
    method: 'DELETE',
    headers: { 'Authorization': `Bearer ${localStorage.getItem('token')}` }
  });
  return response.ok;
